                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="xswatch-account-menu">
                            ...
                            <a class="dropdown-item" href="<{$xoops_url}>/viewpmsg.php"><{$smarty.const.THEME_ACCOUNT_MESSAGES}> <span class="badge badge-primary"><{xoInboxCount}></span></a>
                ...
                <li class="nav-item">
                    <form class="form-inline my-2 my-lg-0" role="search" action="<{xoAppUrl search.php}>" method="get">
                        <div class="input-group">
                            <input class="form-control mr-sm-2" type="text" name="query" placeholder="<{$smarty.const.THEME_SEARCH_TEXT}>">
