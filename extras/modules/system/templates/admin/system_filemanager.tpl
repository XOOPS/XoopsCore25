                    ...
                    <div class="display_file" id="display_file">
                        <div class="xo-btn-actions">
                            <div class="xo-buttons">
                                <button class="ui-corner-all tooltip" type="button" onclick="filemanager_load_tree();filemanager_display_file('', 0)"
                                        title="<{$smarty.const._AM_SYSTEM_FILEMANAGER_HOME}>">
                                    ...
                                    <div style="border: 1px solid #cccccc; ">
                                        <table cellpadding="0" cellspacing='0'>
                                            <tr class="odd">
                                                ...
                                                <td align="right"><{if $files.edit}><img class='cursorpointer' src="<{xoAdminIcons edit.png}>"
                                                                                         onclick='filemanager_edit_file("<{$files.path_file}>", "<{$files.path}>", "<{$files.file}>", "<{$files.extension}>");'
                                                                                         width='16' alt='edit'/><{/if}>&nbsp;<img class='cursorpointer' src="<{xoAdminIcons delete.png}>"
                                                                                                                                  onclick='filemanager_confirm_delete_file("<{$files.path_file}>", "<{$files.path}>", "<{$files.file}>");'
                                                                                                                                  width='16' alt='delete'/></td>
                                            </tr>
                                            <tr>
