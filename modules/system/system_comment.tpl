    ...
    <div class="row">
        <div class="col-12 col-md-12 alignright">
            <{if $xoops_iscommentadmin == true}>
                ...
                <a href="<{$replycomment_link}>&amp;com_id=<{$comment.id}>" title="<{$lang_reply}>" class="btn btn-secondary btn-xs">
                    <span class="fa fa-comment"></span>
                </a>
                <a href="<{$deletecomment_link}>&amp;com_id=<{$comment.id}>" title="<{$lang_delete}>" class="btn btn-secondary btn-xs">
            ...
            <{elseif $xoops_isuser == true || $anon_canpost == true}>
                <a href="<{$replycomment_link}>&amp;com_id=<{$comment.id}>" class="btn btn-secondary btn-xs">
                    <span class="fa fa-comment"></span>
                </a>
            <{else}>
                &nbsp;        <!-- ? -->
