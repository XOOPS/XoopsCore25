...
class XoopsFormSelect extends XoopsFormElement
{
    ...
    public function renderValidationJS()
    {
        ...
        if (!empty($this->customValidationCode)) {
            ...
            return "\nvar hasSelected = false; var selectBox = myform.{$eltname};" . "for (i = 0; i < selectBox.options.length; i++) { if (selectBox.options[i].selected == true && selectBox.options[i].value != '') { hasSelected = true; break; } }"
