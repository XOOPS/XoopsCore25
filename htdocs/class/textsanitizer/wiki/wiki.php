...
class MytsWiki extends MyTextSanitizerExtension
{
    ...
    public function encode($textarea_id)
    {
        ...
        $code       = "<img src='{$this->image_path}/wiki.gif' alt='" . _XOOPS_FORM_ALTWIKI . "' title='" . _XOOPS_FORM_ALTWIKI . "' '" . "' onclick='xoopsCodeWiki(\"{$textarea_id}\",\"" . htmlspecialchars(_XOOPS_FORM_ENTERWIKITERM, ENT_QUOTES)
