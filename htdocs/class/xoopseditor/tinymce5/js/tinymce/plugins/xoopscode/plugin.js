...
(function () {
    ...
    var insertCodeSample = function (editor, language, code) {
      editor.undoManager.transact(function () {
        ...
        return node.fold(function () {
          editor.insertContent('<pre id="__new" class="language-' + language + ' xoopsCode">' + code + '</pre>');
    ...
    var register = function (editor) {
      editor.addCommand('xoopscode', function () {
    ...
    var register$1 = function (editor) {
      editor.ui.registry.addToggleButton('xoopscode', {
        icon: 'code-sample',
        tooltip: 'Insert/edit XOOPS code',
        onAction: function () {
          return open(editor);
        },
