...
/* $Id: Smarty.class.php 12663 2014-06-29 01:44:58Z beckmi $ */
...
class Smarty
{
    ...
    public function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
        ...
        if (!$this->debugging && $this->debugging_ctrl === 'URL') {
            ...
            if (@false !== strpos($_query_string, $this->_smarty_debug_id)) {
                if (@false !== strpos($_query_string, $this->_smarty_debug_id . '=on')) {
                    // enable debugging for this browser session
                    @setcookie('SMARTY_DEBUG', true);
                    $this->debugging = true;
                } elseif (@false !== strpos($_query_string, $this->_smarty_debug_id . '=off')) {
