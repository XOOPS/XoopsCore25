...
$GLOBALS['xoopsLogger']->addDeprecated("'/class/module.errorhandler.php' is deprecated since XOOPS 2.5.4, please create your own error messages instead, called from {$trace[0]['file']} line {$trace[0]['line']}");
