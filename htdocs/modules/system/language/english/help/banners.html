<div id="help-template" class="outer">
    ...
    <p class="even">
        ...
        found in the System Module -> Banners. You can have multiple banners on a XOOPS site – the display area rotates through each of the active banners in turn each time a new page is loaded.<br/><br/>

        Each time a banner is displayed to a visitor this counts as one ‘impression’, which is the common trading currency of banners. Clients typically pay for a certain number of impressions – i.e. to have their advertisement displayed a certain number of times.<br/><br/>
