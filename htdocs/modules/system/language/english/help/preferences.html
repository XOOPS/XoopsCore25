<div id="help-template" class="outer">
    ...
    <p class="even">
        ...
        page. It should represent the content of the site as a whole - the meta information is the same on every page, it currently cannot be customised for different modules or pages.<br/><br/>
        ...
        information on the indexing strategies of your dominant referrers (see your website logfile). This may help you to optimise your meta information or other aspects of your site design and content to improve your rankings. <br/><br/>
    ...
    <p class="even">
        ...
        To implement censorship on your site select the ‘<em>enable</em>’ radio button. You need to enter a list of unwanted words in the ‘<em>words to censor</em>’ box, separating them with the pipe character. This function is case insensitive. Enter a suitable replacement term in the ‘<em>replace
            bad words with</em>’ box. The default is #OOPS#.
    ...
    <p class="even">
        ...
        number of records, many of which may be irrelevant. Longer keywords tend to retrieve fewer records but with a higher degree of precision.<br/><br/>
