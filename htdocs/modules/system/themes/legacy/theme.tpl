        ...
        <td align="left" colspan="3" class="bg5">
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="hbar_middle alignmiddle">&nbsp;<a href='<{$xoops_url}>/admin.php'><{$smarty.const._CPHOME}></a>&nbsp;|&nbsp;<a
                                href='<{xoAppUrl modules/system/help.php}>'><{$smarty.const._AM_SYSTEM_HELP}></a>&nbsp;|&nbsp;<a
                                href='<{$xoops_url}>/admin.php?xoopsorgnews=1'>XOOPS News</a></td>
                    <td class="hbar_middle alignmiddle" align='right'><a href='<{$xoops_url}>/user.php?op=logout'><{$smarty.const._LOGOUT}></a>&nbsp;|&nbsp;<a
                                href='<{$xoops_url}>/'><{$smarty.const._YOURHOME}></a> &nbsp;</td>
            ...
            <table border='0' width='100%' cellspacing='0' cellpadding='0'>
                <tr>
                    ...
                    <td width='99%' class='hbar_middle alignmiddle center'>
                        <div class='fontSmall'>Powered by&nbsp;<{$smarty.const.XOOPS_VERSION}> &copy; 2001-<{$smarty.now|date_format:"%Y"}> <a
                                    href='http://xoops.org/' rel='external' title='The XOOPS Project'>The XOOPS Project</a></div>
                    </td>
