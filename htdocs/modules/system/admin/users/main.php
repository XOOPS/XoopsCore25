    ...
    default:
        ...
        if (isset($_REQUEST['complet_search'])) {
            ...
            if (!empty($_REQUEST['user_uname'])) {
                ...
                $requete_pagenav .= '&amp;user_uname=' . htmlspecialchars($_REQUEST['user_uname'], ENT_QUOTES | ENT_HTML5) . '&amp;user_uname_match=' . htmlspecialchars($_REQUEST['user_uname_match'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_name'])) {
                ...
                $requete_pagenav .= '&amp;user_name=' . htmlspecialchars($_REQUEST['user_name'], ENT_QUOTES | ENT_HTML5) . '&amp;user_name_match=' . htmlspecialchars($_REQUEST['user_name_match'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_email'])) {
                ...
                $requete_pagenav .= '&amp;user_email=' . htmlspecialchars($_REQUEST['user_email'], ENT_QUOTES | ENT_HTML5) . '&amp;user_email_match=' . htmlspecialchars($_REQUEST['user_email_match'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_url'])) {
                ...
                $requete_pagenav .= '&amp;user_url=' . htmlspecialchars($_REQUEST['user_url'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_icq'])) {
                ...
                $requete_pagenav .= '&amp;user_icq=' . htmlspecialchars($_REQUEST['user_icq'], ENT_QUOTES | ENT_HTML5) . '&amp;user_icq_match=' . htmlspecialchars($_REQUEST['user_icq_match'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_aim'])) {
                ...
                $requete_pagenav .= '&amp;user_aim=' . htmlspecialchars($_REQUEST['user_aim'], ENT_QUOTES | ENT_HTML5) . '&amp;user_aim_match=' . htmlspecialchars($_REQUEST['user_aim_match'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_yim'])) {
                ...
                $requete_pagenav .= '&amp;user_yim=' . htmlspecialchars($_REQUEST['user_yim'], ENT_QUOTES | ENT_HTML5) . '&amp;user_yim_match=' . htmlspecialchars($_REQUEST['user_yim_match'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_msnm'])) {
                ...
                $requete_pagenav .= '&amp;user_msnm=' . htmlspecialchars($_REQUEST['user_msnm'], ENT_QUOTES | ENT_HTML5) . '&amp;user_msnm_match=' . htmlspecialchars($_REQUEST['user_msnm_match'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_from'])) {
                ...
                $requete_pagenav .= '&amp;user_from=' . htmlspecialchars($_REQUEST['user_from'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_intrest'])) {
                ...
                $requete_pagenav .= '&amp;user_intrest=' . htmlspecialchars($_REQUEST['user_intrest'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_occ'])) {
                ...
                $requete_pagenav .= '&amp;user_occ=' . htmlspecialchars($_REQUEST['user_occ'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_lastlog_more']) && is_numeric($_REQUEST['user_lastlog_more'])) {
                ...
                $requete_pagenav .= '&amp;user_lastlog_more=' . htmlspecialchars($_REQUEST['user_lastlog_more'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_lastlog_less']) && is_numeric($_REQUEST['user_lastlog_less'])) {
                ...
                $requete_pagenav .= '&amp;user_lastlog_less=' . htmlspecialchars($_REQUEST['user_lastlog_less'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_reg_more']) && is_numeric($_REQUEST['user_reg_more'])) {
                ...
                $requete_pagenav .= '&amp;user_regdate=' . htmlspecialchars($_REQUEST['user_regdate'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_reg_less']) && is_numeric($_REQUEST['user_reg_less'])) {
                ...
                $requete_pagenav .= '&amp;user_reg_less=' . htmlspecialchars($_REQUEST['user_reg_less'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_posts_more']) && is_numeric($_REQUEST['user_posts_more'])) {
                ...
                $requete_pagenav .= '&amp;user_posts_more=' . htmlspecialchars($_REQUEST['user_posts_more'], ENT_QUOTES);
            ...
            if (!empty($_REQUEST['user_posts_less']) && is_numeric($_REQUEST['user_posts_less'])) {
                ...
                $requete_pagenav .= '&amp;user_posts_less=' . htmlspecialchars($_REQUEST['user_posts_less'], ENT_QUOTES);
            ...
            if (isset($_REQUEST['user_mailok'])) {
                ...
                $requete_pagenav .= '&amp;user_mailok=' . htmlspecialchars($_REQUEST['user_mailok'], ENT_QUOTES);
            ...
            if (isset($_REQUEST['user_type']) && !empty($_REQUEST['user_type'])) {
                ...
                $requete_pagenav .= '&amp;user_type=' . htmlspecialchars($_REQUEST['user_type'], ENT_QUOTES);
            } else {
                $criteria->add(new Criteria('level', 0, '>='));
                $user_type = '';
            ...
            if (isset($_REQUEST['user_sort'])) {
                ...
                $requete_pagenav .= '&amp;user_sort=' . htmlspecialchars($_REQUEST['user_sort'], ENT_QUOTES);
            ...
            if (isset($_REQUEST['user_limit'])) {
                ...
                $requete_pagenav .= '&amp;user_limit=' . htmlspecialchars($_REQUEST['user_limit'], ENT_QUOTES);
            ...
            if (isset($_REQUEST['selgroups'])) {
                ...
                $requete_pagenav .= '&amp;selgroups=' . htmlspecialchars($_REQUEST['selgroups'], ENT_QUOTES);
            } else {
                $groups = array();
            }
            //print_r($groups);
