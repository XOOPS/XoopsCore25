...
<{if $viewer_level gt 1}>
    <div class="right" id="admin">
        ...
        <form id="form_posts_admin" name="form_posts_admin" action="action.post.php" method="POST" onsubmit="if(window.document.form_posts_admin.op.value &lt; 1){return false;}">
            ...
            <a class="btn btn-default" href="<{$xoops_url}>/modules/<{$xoops_dirname}>/viewpost.php?uid=<{$uid}>" target="_self" title="<{$smarty.const._MD_NEWBB_TYPE_VIEW}>"><{$smarty.const._MD_NEWBB_TYPE_VIEW}></a>
        </form>
        <{else}>
            <a class="btn btn-default" href="<{$xoops_url}>/modules/<{$xoops_dirname}>/viewpost.php?uid=<{$uid}>&amp;status=active#admin" target="_self" title="<{$smarty.const._MD_NEWBB_TYPE_ADMIN}>"><{$smarty.const._MD_NEWBB_TYPE_ADMIN}></a>
            <a class="btn btn-default" href="<{$xoops_url}>/modules/<{$xoops_dirname}>/viewpost.php?uid=<{$uid}>&amp;status=pending#admin" target="_self" title="<{$smarty.const._MD_NEWBB_TYPE_PENDING}>"><{$smarty.const._MD_NEWBB_TYPE_PENDING}></a>
            <a class="btn btn-default" href="<{$xoops_url}>/modules/<{$xoops_dirname}>/viewpost.php?uid=<{$uid}>&amp;status=deleted#admin" target="_self" title="<{$smarty.const._MD_NEWBB_TYPE_DELETED}>"><{$smarty.const._MD_NEWBB_TYPE_DELETED}></a>
        <{/if}>
    </div>
    <div class="clear"></div>
<{/if}>
...
<div style="padding: 5px;">
    <a id="threadtop"></a><a href="#threadbottom"><span class="glyphicon glyphicon-arrow-down"></span> <{$smarty.const._MD_NEWBB_BOTTOM}></a>
</div>
...
<div>
    <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="topicoption">
            ...
            <li><a href="<{$all_link}>"><{$smarty.const._MD_NEWBB_VIEW}>&nbsp;<{$smarty.const._MD_NEWBB_ALL}></a></li>
        </ul>
    </div>
    <div class="dropdown">
        <button class="btn btn-default dropdown-toggle" type="button" id="viewmode" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
            <{$smarty.const._MD_NEWBB_VIEWMODE}>
            <span class="caret"></span>
        </button>
...
<div>
    <div class="icon_left">
        <a id="threadbottom"></a><a href="#threadtop"><span class="glyphicon glyphicon-arrow-up"></span> <{$smarty.const._MD_NEWBB_TOP}></a>
    </div>
