    ...
    <ul class="list-unstyled">
        <{foreach item=photo from=$block.photos|default:null}>
            <li class="mb10 text-center">
                <a class="btn btn-primary w-100 btn-sm" title="<{$photo.photo_title}>" href="<{$xoops_url}>/modules/extgallery/public-photo.php?photoId=<{$photo.photo_id}>"><{$photo.photo_title}></a>
