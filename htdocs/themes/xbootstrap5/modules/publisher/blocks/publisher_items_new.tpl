...
<{foreach item=newitems from=$block.newitems|default:null}>
    <tr class="<{cycle values=" even,odd"}>">
        ...
        <td>
            ...
            <br>
            <span style="padding: 3px 16px 0 0; font-size: 11px;"><span class="fa-solid fa-user"></span>&nbsp;<{$newitems.poster}></span>
            <{if $block.show_order == '1'}>
                <span style="padding: 3px 16px 0 0; font-size: 11px;"><span class="fa-solid fa-calendar"></span><{$newitems.new}></span>
            <{/if}>
        </td>
    </tr>
<{/foreach}>
