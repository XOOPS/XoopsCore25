            ...
            <div class="newbb-header-icons hidden-xs">
                <{if $viewer_level >= 1}>
                    <div class="col-md-6 mb10">
                        ...
                        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/list.topic.php?status=active#admin" title="<{$smarty.const._MD_TYPE_ADMIN}>" class="btn btn-sm btn-primary">
                            <{$smarty.const._MD_TYPE_ADMIN}>
                        </a>

                        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/list.topic.php?status=pending#admin" title="<{$smarty.const._MD_TYPE_PENDING}>" class="btn btn-sm btn-primary">
                            <{if $wait_new_topic|default:false}><span class="badge"><{$wait_new_topic}></span><{/if}> <{$smarty.const._MD_TYPE_PENDING}>
                        </a>

                        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/list.topic.php?status=deleted#admin" title="<{$smarty.const._MD_TYPE_DELETED}>" class="btn btn-sm btn-danger">
                ...
                <{if $viewer_level >= 1}>
                    <div class="col-md-12">
                        ...
                        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/viewpost.php?status=active#admin" title="<{$smarty.const._MD_TYPE_ADMIN}>" class="btn btn-sm btn-primary">
                            <{$smarty.const._MD_TYPE_ADMIN}>
                        </a>

                        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/viewpost.php?status=pending#admin" title="<{$smarty.const._MD_TYPE_PENDING}>" class="btn btn-sm btn-primary">
                            <{if $wait_new_post|default:false}>(<span style="color:red;"><{$wait_new_post}></span>)<{/if}> <{$smarty.const._MD_TYPE_PENDING}>
                        </a>

                        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/viewpost.php?status=deleted#admin" title="<{$smarty.const._MD_TYPE_DELETED}>" class="btn btn-sm btn-primary">
