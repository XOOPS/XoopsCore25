<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php"><{$index_module}></a></li>
            <li class="breadcrumb-item active"><{$smarty.const._MD_XMCONTACT_INDEX_CONFIRM}></li>
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-3 col-md-4 col-lg-3 text-center" style="padding-bottom: 5px; padding-top: 5px;">
            <img class="rounded img-fluid" src="<{$categoryitem.logo}>" alt="<{$categoryitem.title}>">
        </div>
        <div class="col-9 col-md-8 col-lg-9" style="padding-bottom: 5px; padding-top: 5px;">
            <h4 class="mt-0"><{$categoryitem.title}></h4>
            <{$categoryitem.description}>
            <br>
            <a href="index.php?op=form&cat_id=<{$categoryitem.id}>">
