				...
				<div class="card xmnews-border" <{if $blocknews.color != false}>style="border-color : <{$blocknews.color}>;"<{/if}>>
					...
					<div class="card-body text-center">
						<div class="row" >
							...
							<div class="col-12 pt-2 text-start text-muted xmnews-data">
						...
						<div class="d-flex justify-content-between">
							...
							<{if $blocknews.dohits == 1}>
								<div class="row align-items-center text-end">
									<div class="col">
										<span class="badge text-bg-secondary fa-lg text-primary ms-2"><span class="fa fa-eye fa-lg" aria-hidden="true"></span><small> <{$blocknews.hits}></small></span>
									</div>	
								</div>	
							<{/if}>
						</div>
						...
						<div class="col d-flex flex-column position-static">
							...
							<p class="card-text mb-auto">
								<div class="row">
									<div class="col">
										<{if $blocknews.logo != ''}>
											<img class="col-3 rounded float-end d-none d-md-block" src="<{$blocknews.logo}>" alt="<{$blocknews.title}>">
										<{/if}>
										<p>
										<{$blocknews.news}>
										</p>
