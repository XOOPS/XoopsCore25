<div id="xmnews-carousel<{$block.randid}>" class="carousel slide" data-bs-ride="carousel">
	<ol class="carousel-indicators">
		<{foreach item=indicators from=$block.carousel_indicators}>
			<li data-bs-target="#xmnews-carousel<{$block.randid}>" data-bs-slide-to="<{$indicators}>" <{if $indicators == 0}>class="active"<{/if}>></li>
		<{/foreach}>
	</ol>
	...
	<a class="carousel-control-prev" href="#xmnews-carousel<{$block.randid}>" role="button" data-bs-slide="prev">
		<span class="carousel-control-prev-icon" aria-hidden="true"></span>
		<span class="visually-hidden">Previous</span>
	</a>
	<a class="carousel-control-next" href="#xmnews-carousel<{$block.randid}>" role="button" data-bs-slide="next">
