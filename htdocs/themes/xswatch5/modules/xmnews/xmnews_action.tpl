							...
							<div class="row" style="height: 150px;">
								...
								<div class="col-12 pt-2">	
									<{if $category.description != ""}>
										<button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#xmDesc-<{$category.id}>">+</button>
									<{else}>
										<button class="btn btn-primary btn-sm" data-bs-toggle="modal" disabled>+</button>
									<{/if}>
								</div>								
							</div>				
						</div>				
