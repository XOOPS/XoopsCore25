<div class="xmmews">
					...
					<div class="d-flex justify-content-between">
						...
						<{if $dohits == 1}>
							<div class="row align-items-center text-end">
								<div class="col">
									<span class="badge border border-primary fa-lg text-primary ms-2"><span class="fa fa-eye fa-lg" aria-hidden="true"></span><small> <{$counter}></small></span>
								</div>	
							</div>	
						<{/if}>
					</div>
				...
				<{if ($douser == 1) || ($dodate == 1) || (($domdate == 1) && ($mdate)) || ($dorating == 1) }> 
					<div class="row border-bottom border-secondary mx-1 ps-1">
						...
						<{if ($dodate == 1) && (($domdate == 1) && ($mdate|default:false)) && ($douser == 1)}>
							<figure class="figure text-muted m-1 pe-2 text-center border-end border-secondary">
					...
					<p class="card-text mb-auto">
						<div class="row">
							<div class="col">
								...
								<{/if}>
								<img class="col-3 rounded float-end d-none d-md-block" src="<{$logo}>" alt="<{$title}>">
								<{if $CAT == true}>
								</a>
								<{/if}>
								<{/if}>
				...
				<{if $news_before_status == true}>
					<a href="article.php?news_id=<{$news_before_id}>" class="btn btn-primary btn-block" <{if $news_before_color != false}>style="border-color : <{$news_before_color}>;"<{/if}>">
						<div class="d-flex justify-content-between align-items-center">
							<div class="text-start"><span class="fa fa-long-arrow-left fa-2x"></span></div>
							<div class="text-end">
				...
				<{if $news_after_status == true}>
					<a href="article.php?news_id=<{$news_after_id}>" class="btn btn-primary btn-block" <{if $news_after_color != false}>style="border-color : <{$news_after_color}>;"<{/if}>">
						<div class="d-flex justify-content-between align-items-center">
							...
							<div class="text-end"><span class="fa fa-long-arrow-right fa-2x"></span></div>
						</div>
					</a>
				<{/if}>
			</div>
	...
	<div class="col-12 ps-4 pe-4 pb-2">
