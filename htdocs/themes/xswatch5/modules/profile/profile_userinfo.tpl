                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item list-group-item-action">
                            ...
                            <{if file_exists($path_image_overloaded)}>
                                ...
                                <div class="d-inline text-muted"><small><span class="fa fa-calendar fa-sm ms-2"></span> <{$result.time}></small></div>
                                <br />
                            <{else}>
                                <img src="<{$result.image}>" alt="<{$module.name}>"> <a href="<{$result.link}>"><{$result.title}></a> <small><span class="fa fa-calendar fa-sm ms-2"></span> <{$result.time}></small><br />
                            <{/if}>
                        </li>
                        <{/foreach}>
                    </ul>
