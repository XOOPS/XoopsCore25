				...
				<div class="card-header">
					<h5>
						...
						<{if $searchitem.module_show_all|default:false}>
							...
							<span class="d-inline d-sm-none">| <span class="ms-2"></span><a href="<{$searchitem.module_show_all}>"><span class="fa fa-search-plus fa-flip-horizontal fa-lg"></span></a></span>
						<{/if}>
					</h5>
				</div>
	...
	<!-- Alain01 -->
								...
								<{if $data.uname|default:''}>
									...
									<div class="d-none d-md-inline">
										<br />
										<small><span class="fa fa-user fa-sm ms-2 text-muted"></span> <a href="<{$data.uname_link}>"><{$data.uname}></a></small>

										<{if $data.time}>
											<small><span class="text-muted"><span class="fa fa-calendar fa-sm ms-2"></span> <{$data.time}></span></small>
										<{/if}>
									</div>
								<{/if}>
							</li>
	...
	<!-- Alain01 -->
							...
							<{if $data.uname}>
								...
								<div class="d-none d-md-inline text-muted">
									<br />
									<small><span class="fa fa-user fa-sm ms-2"></span> <a href="<{$data.uname_link}>"><{$data.uname}></a></small>

									<{if $data.time}>
										<small><span class="fa fa-calendar fa-sm ms-2"></span> <{$data.time}></small>
									<{/if}>
								</div>
							<{/if}>
							<br />
