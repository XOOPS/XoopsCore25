...
<div class="row mb-3">
    ...
    <div class="col-12 col-md-6">
        ...
        <div id="extEventSlides" class="carousel slide mt-2 mb-2" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <{assign var=active value=''}>
                <{/if}>
                <button class="carousel-control-prev" type="button" data-bs-target="#extEventSlides" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden"><{$smarty.const.THEME_CONTROL_PREVIOUS}></span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#extEventSlides" data-bs-slide="next">
...
<{if !empty($whosGoing)}>
<div class="mt-3 mb-3">
    <h5><{$smarty.const._MD_EXTCAL_WHOS_GOING}> <span class="badge bg-secondary"><{$eventmember.member.nbUser}></span></h5>
...
<div class="mt-3 mb-3">
    <h5><{$smarty.const._MD_EXTCAL_WHOSNOT_GOING}> <span class="badge bg-secondary"><{$eventmember.notmember.nbUser}></span></h5>
