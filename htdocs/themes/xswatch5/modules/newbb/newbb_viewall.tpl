        ...
        <div>
            <div>
                <{if isset($menumode) && $menumode == 0}>
                    <select class="form-select menu" name="topicoption" id="topicoption" onchange="if(this.options[this.selectedIndex].value.length >0 )    { window.document.location=this.options[this.selectedIndex].value;}">
                ...
                <{elseif isset($menumode) && $menumode == 1}>
                ...
                <{elseif isset($menumode) && $menumode == 2}>
                    <div class="menu">
                        <ul>
                            <li>
        ...
        <{strip}>
            <form class="xoopsform" method="get" action="<{$selection.action}>">
                <ul class="list-inline">
                    ...
                    <li><{$selection.sort|replace:'<select name':'<select class="form-select" name'}></li>
                    <li><{$selection.order|replace:'<select name':'<select class="form-select" name'}></li>
...
<{if isset($pagenav)}>
    <!-- irmtfan hardcode removed style="padding: 5px;float: right; text-align:right;" -->
    <div class="generic-pagination col text-end"><{$pagenav|replace:'form':'div'|replace:'id="xo-pagenav"':''|replace:' //':'/'}>
