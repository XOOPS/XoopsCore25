        ...
        <{if isset($topic_post.poster.uid) && $topic_post.poster.uid != 0}>
            ...
            <{/if}>
                ...
                <{if isset($infobox.show)}>
                    <button  data-bs-toggle="collapse" data-bs-target="#p<{$topic_post.post_id}>" title="<{$smarty.const.THEME_INFO}>" class="btn btn-primary btn-sm mb10"><span class="fa fa-info"></span></button>
