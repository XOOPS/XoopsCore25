        ...
        <{if isset($topic_post.poster.uid) && $topic_post.poster.uid != 0}>
            ...
            <{/if}>
                ...
                <{if !empty($infobox.show)}>
                    <button  data-bs-toggle="collapse" data-bs-target="#p<{$topic_post.post_id}>" title="<{$smarty.const.THEME_INFO}>" class="btn btn-primary btn-sm mb10"><span class="fa-solid fa-info"></span></button>
...
<div class="row clearfix newbb-links mb10">
    <div class="col-3 me-auto d-none d-sm-block">
