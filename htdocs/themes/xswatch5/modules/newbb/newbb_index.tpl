<div class="newbb">
    ...
    <div class="bg-light mb-4 rounded-2 py-5 px-3 newbb-header">
        <h3>
                ...
                <div class="col">
                    <strong><{$smarty.const._MD_NEWBB_TOPIC}>:</strong>
                        ...
                        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/list.topic.php?status=pending#admin" title="<{$smarty.const._MD_NEWBB_TYPE_PENDING}>" class="btn btn-primary">
                            <span class="fa fa-check-square-o" aria-hidden="true"></span> <{if !empty($wait_new_topic)}><span class="badge text-bg-light rounded-pill"><{$wait_new_topic}></span><{/if}>
                        </a>
                        ...
                        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/list.topic.php?status=deleted#admin" title="<{$smarty.const._MD_NEWBB_TYPE_DELETED}>" class="btn btn-danger">
                            <span class="fa fa-trash-o" aria-hidden="true"></span> <{if !empty($delete_topic)}><span class="badge text-bg-light rounded-pill"><{$delete_topic}></span><{/if}>
                        </a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col">
                    ...
                    <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/viewpost.php?status=pending#admin" title="<{$smarty.const._MD_NEWBB_TYPE_PENDING}>" class="btn btn-primary">
                        <span class="fa fa-check-square-o" aria-hidden="true"></span> <{if !empty($wait_new_post)}><span class="badge text-bg-light rounded-pill"><{$wait_new_post}></span><{/if}>
                    </a>
                    ...
                    <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/viewpost.php?status=deleted#admin" title="<{$smarty.const._MD_NEWBB_TYPE_DELETED}>" class="btn btn-primary">
                        <span class="fa fa-trash-o" aria-hidden="true"></span> <{if !empty($delete_post)}><span class="badge text-bg-light rounded-pill"><{$delete_post}></span><{/if}>
                    </a>
                    ...
                    <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/admin/admin_report.php" title="_MD_NEWBB_REPORT" class="btn btn-primary">
                        <span class="fa fa-thumbs-o-down" aria-hidden="true"></span> <span class="badge text-bg-light rounded-pill"><{$reported_count}></span>
                    </a>
                    <{/if}>
    ...
    <table class="table table-hover">
        ...
        <tr class="thead-light">
            <th scope="col" colspan="5">
                ...
                <span class="fw-bold"><a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/index.php?cat=<{$category.cat_id}>" title="<{$category.cat_title}>"><{$category.cat_title}></a></span>
