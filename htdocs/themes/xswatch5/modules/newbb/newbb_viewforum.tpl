        ...
        <div class="row">
            <div class="col-md-8 col-xs-12">
                <{if isset($mode) && $mode > 1}>
                    <form class="d-flex align-items-center" name="form_topics_admin" action="<{$xoops_url}>/modules/<{$xoops_dirname}>/action.topic.php" method="POST" onsubmit="if(window.document.form_topics_admin.op.value &lt; 1){return false;}">
                <{/if}>
                ...
                <{if isset($mode) && $mode > 1}>
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <select name="op" class="form-select mb-2">                        <option value="0"><{$smarty.const._SELECT}></option>
...
<div class="row mb10">
    <div class="col-md-12">
        <{strip}>
            ...
            <li><{$forum_selection_sort|replace:'<select name':'<select class="form-select" name'}></li>
            <li><{$forum_selection_order|replace:'<select name':'<select class="form-select" name'}></li>
    ...
    <div class="col-sm-2 col-md-2"><a data-bs-toggle="collapse" href="#forum-info" class="btn btn-info" title="<{$smarty.const.THEME_PERMISSIONS_LEGEND}>"><span class="fa fa-info"></span></a></div>
    <div class="col-sm-10 col-md-10 text-end xoopsform"><{$forum_jumpbox|replace:' class="select"':' class="btn btn-light"'|replace:"'button'":'"btn btn-sm btn-light"'}></div>
<!--<{$forum_addpoll}>-->
</div>
