				...
				<div class="row d-flex justify-content-center" >
					...
					<div class="col-6 col-md-11 col-xl-9 btn-group" role="group">
						<{if $block.use_modal == 1}>
							<a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal<{$blockdocument.id}>" role="button"> <span class="fa fa-info-circle fa-lg text-light" aria-hidden="true"></span></a>
						<{else}>
					...
					<div class="row text-end">
						<div class="col">
							<{if $blockdocument.showinfo == 1}>
								<span class="badge text-bg-secondary fa-lg text-primary ms-1"><span class="fa fa-download" aria-hidden="true"></span><small> <{$blockdocument.counter}></small></span>
								<{if $blockdocument.size != ''}>
									<span class="badge text-bg-secondary fa-lg text-primary ms-1 mt-1 mt-lg-0"><span class="fa fa-archive" aria-hidden="true"></span><small> <{$blockdocument.size}></small></span>
								<{/if}>	
							<{/if}>
