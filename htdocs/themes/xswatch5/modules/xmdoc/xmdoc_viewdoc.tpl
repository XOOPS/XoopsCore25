			...
			<div class="card-body text-center">
				<div class="row d-flex justify-content-center" >
					...
					<div class="col-10 col-md-11 col-xl-10 btn-group" role="group">
						<{if $use_modal == 1}>
							<a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal<{$viewdocument.id}>" role="button"> <span class="fa fa-info-circle fa-lg text-light" aria-hidden="true"></span></a>
						<{else}>
					...
					<div class="row text-end">
						<div class="col">
							<{if $viewdocument.showinfo == 1}>
								<span class="badge text-bg-secondary fa-lg text-primary ms-1"><span class="fa fa-download" aria-hidden="true"></span><small> <{$viewdocument.counter}></small></span>
								<{if $viewdocument.size != ''}>
									<span class="badge text-bg-secondary fa-lg text-primary ms-1 mt-1 mt-lg-0"><span class="fa fa-archive" aria-hidden="true"></span><small> <{$viewdocument.size}></small></span>
								<{/if}>
							<{/if}>
