					...
					<div class="d-flex justify-content-between">
						...
						<{if $showinfo == 1}>
							<div class="row align-items-center text-end">
								<div class="col">
									<span class="badge text-bg-secondary fa-lg text-primary ms-1"><span class="fa fa-download" aria-hidden="true"></span><small> <{$counter}></small></span>
									<{if $size != ''}>
										<span class="badge text-bg-secondary fa-lg text-primary ms-1 mt-1 mt-lg-0"><span class="fa fa-archive" aria-hidden="true"></span><small> <{$size}></small></span>
									<{/if}>	
								</div>	
							</div>
						<{/if}>						
