...
<div align="center">
	...
	<form class="d-flex align-items-center" id="form_document_tri" name="form_document_tri" method="get" action="index.php">
		<div class="mb-3">
			<label><{$smarty.const._MA_XMDOC_INDEX_SELECTCATEGORY}>&nbsp;</label>
			<select class="form-select form-select-sm" name="news_filter" id="news_filter" onchange="location='index.php?doc_cid='+this.options[this.selectedIndex].value">
				<{$doc_cid_options}>
			</select>
		</div>
	</form>
					...
					<div class="card-body text-center">
						<div class="row d-flex justify-content-center">
							...
							<div class="col-6 col-md-11 col-xl-9 btn-group" role="group">
								<{if $use_modal == 1}>
									<a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal<{$document.id}>" role="button"> <span class="fa fa-info-circle fa-lg text-light" aria-hidden="true"></span></a>
								<{else}>
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
							...
							<div class="row text-end">
								<div class="col">
									<{if $document.showinfo == 1}>
										<span class="badge text-bg-secondary fa-lg text-primary ms-1"><span class="fa fa-download" aria-hidden="true"></span><small> <{$document.counter}></small></span>
										<{if $document.size != ''}>
											<span class="badge text-bg-secondary fa-lg text-primary ms-1 mt-1 mt-lg-0"><span class="fa fa-archive" aria-hidden="true"></span><small> <{$document.size}></small></span>
										<{/if}>	
									<{/if}>
						...
						<div class="modal-body">
							<{if $document.showinfo == 1}>
								<div class="row border-bottom border-secondary mx-1 ps-1">
									<figure class="figure text-muted my-1 pe-2 text-center border-end border-secondary">
									...
									<figure class="text-muted m-1 pe-2 text-center border-end border-secondary">
