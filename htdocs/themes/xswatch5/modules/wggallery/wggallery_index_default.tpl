...
<{if isset($albums)}>
    ...
    <div class="col mt-2 mb-2">
        <div class="generic-pagination xo-pagenav float-end"><{$pagenav_albums|replace:'form':'div'|replace:'id="xo-pagenav"':''|replace:' //':'/'}></div>
    </div>
    <{/if}>
<{/if}>
<{if isset($categories)}>
    ...
    <{if isset($pagenav_cats)}>
        <div class="col mb-2 mb-2">
            <div class="generic-pagination xo-pagenav float-end"><{$pagenav_cats|replace:'form':'div'|replace:'id="xo-pagenav"':''|replace:' //':'/'}></div>
        </div>
    <{/if}>
<{/if}>
