<{if isset($images_list)}>
    <div id="wgBlockImagesCarouselSlides" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <{/foreach}>
            <button class="carousel-control-prev" type="button" data-bs-target="#wgBlockImagesCarouselSlides" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden"><{$smarty.const.THEME_CONTROL_PREVIOUS}></span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#wgBlockImagesCarouselSlides" data-bs-slide="next">
