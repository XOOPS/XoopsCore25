<{if isset($images_list)}>
    <div id="wgBlockImagesCarouselSlides" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <{/foreach}>
            <a class="carousel-control-prev" href="#wgBlockImagesCarouselSlides" role="button" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden"<{$smarty.const.THEME_CONTROL_PREVIOUS}>/span>
            </a>
            <a class="carousel-control-next" href="#wgBlockImagesCarouselSlides" role="button" data-bs-slide="next">
