...
<{if isset($albums_list)}>
	...
	<{if isset($pagenav)}>
		<div class="col">
		<div class="generic-pagination xo-pagenav float-end"><{$pagenav|replace:'form':'div'|replace:'id="xo-pagenav"':''|replace:' //':'/'}></div>
		</div>
	<{/if}>
	</div>
...
<{if isset($form)}>
    ...
    <script type="application/javascript">
        document.getElementById('myModalImagePicker').addEventListener('shown.bs.modal', function () {
            document.getElementById('alb_imgid').focus();
        });
        $(".img").click(function () {
            ...
            bootstrap.Modal.getInstance(document.getElementById('myModalImagePicker')).hide();
            return false;
        })
    </script>
