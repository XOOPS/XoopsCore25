...
- Edit `xswatch5.conf` to pick your Bootswatch variant (e.g., css-cerulean, css-slate).
...
- Customize `css/my_xoops.css` to add your CSS definitions and override Bootstrap definitions. Use `[data-bs-theme="dark"]` selectors for dark mode overrides.
