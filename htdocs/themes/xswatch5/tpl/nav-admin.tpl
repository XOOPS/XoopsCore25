...
<script type="text/javascript">
    let toolbar_block_edits = false;

    function xswatchEnableBlockEdits() {
        if (toolbar_block_edits) {
            document.querySelectorAll('.toolbar-block-edit').forEach(function(el) { el.style.display = 'none'; });
            toolbar_block_edits = false;
        } else {
            document.querySelectorAll('.toolbar-block-edit').forEach(function(el) { el.style.display = ''; });
            toolbar_block_edits = true;
        }
    }
    function xswatchToolbarIndOn() {
        document.getElementById('xswatch-toolbar-ind').className = 'fa-solid fa-toggle-on';
        document.getElementById('xswatch-toolbar').style.display = '';
    }
    function xswatchToolbarIndOff() {
        document.getElementById('xswatch-toolbar-ind').className = 'fa-solid fa-toggle-off';
        document.getElementById('xswatch-toolbar').style.display = 'none';
    }
    function xswatchToolbarToggle() {
        let toolbar_cookie = Cookies.get('xswatch-toolbar');
    ...
    const toolbar_cookie = Cookies.get('xswatch-toolbar');
    if (toolbar_cookie == 'off') {
        xswatchToolbarIndOff();
    } else {
        xswatchToolbarIndOn();
