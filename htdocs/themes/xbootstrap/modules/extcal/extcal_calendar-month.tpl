    ...
    <table class="table table-bordered table-hover">
        <tr style="text-align:center;">
            ...
            <td colspan="2" class="even"><a
                        href="<{$xoops_url}>/modules/extcal/calendar-month.php?<{$navig.prev.uri}>">
                    &lt;&lt; <{$navig.prev.name}></a></td>
            <td colspan="3" class="even"><span style="font-weight:bold;"><{$navig.this.name}></span>
            </td>
            <td colspan="2" class="even"><a
                        href="<{$xoops_url}>/modules/extcal/calendar-month.php?<{$navig.next.uri}>"><{$navig.next.name}>
                    &gt;&gt;</a></td>
        </tr>
        ...
        <tr>
            <th style="text-align:center; vertical-align:middle;"><a
                        href="calendar-week.php?year=<{$row.weekInfo.year}>&amp;month=<{$row.weekInfo.month}>&amp;day=<{$row.weekInfo.day}>"><{$row.weekInfo.week}></a>
            </th>
            ...
            <td class="<{if $cell.isEmpty}>even<{else}>odd<{/if}>"
                ...
                href="<{$xoops_url}>/modules/extcal/day.php?year=<{$year}>&amp;month=<{$month}>&amp;day=<{$cell.number}>"><{$cell.number}></a><{/if}><br/>
