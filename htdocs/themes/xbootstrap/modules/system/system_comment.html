<div class="xoops-comment-template" id="comment<{$comment.id}>">
        <div class="row hidden-xs">
            ...
            <div class="col-xs-4 col-md-4"><small class="label label-info"><strong><{$lang_posted}></strong> <{$comment.date_posted}></small></div><!-- .col-md-3 -->
            <div class="col-xs-5 col-md-5"><small class="label label-info"><strong><{$lang_updated}></strong> <{$comment.date_modified}></small></div><!-- .col-md-3 -->
        </div><!-- row -->
