<div id="xo-system-userinfo">
                ...
                <table class="width100 center">
                    <tr class="center">
                        <td>
                            ...
                            <{/if}>
                            <input type="button" value="<{$lang_logout}>" onclick="location='user.php?op=logout'"/>
                        </td>
                    </tr>
                </table>
            </form>
        ...
        <tr class="top">
            <td class="width50">
                <table class="outer width100" cellpadding="4" cellspacing="1">
                    <tr>
                        <th colspan="2" class="center"><{$lang_allaboutuser}></th>
                    </tr>
                    <{if $user_avatarurl}>
                        <tr class="top">
            ...
            <td class="width50">
                <table class="outer width100" cellpadding="4" cellspacing="1">
                    <tr class="top">
                        <th colspan="2" class="center"><{$lang_statistics}></th>
                    </tr>
                    <tr class="top">
                        <td class="head"><{$lang_membersince}></td>
                        <td class="center even"><{$user_joindate}></td>
                    </tr>
                    <tr class="top">
                    ...
                    <tr class="top">
                        ...
                        <td class="center even"><{$user_posts}></td>
                    </tr>
                    <tr class="top">
                        <td class="head"><{$lang_lastlogin}></td>
                        <td class="center odd"><{$user_lastlogin}></td>
                    </tr>
                </table>
                <{if $user_signature}>
                    <br/>
    ...
    <{foreach item=module from=$modules}>
        ...
        <{foreach item=result from=$module.results}>
            <p><img class="xo-icons" src="<{$result.image}>" alt="<{$module.name}>"/><strong><a href="<{$result.link}>" title="<{$result.title}>"><{$result.title}></a></strong>
                - <span class="small italic">(<{$result.time}>)</span></p>
        <{/foreach}>
