...
require_once(XOOPS_TU_ROOT_PATH . '/class/xoopsform/formpassword.php');

class XoopsFormPasswordTest extends TestCase
{
    ...
    public function test___construct()
    {
        ...
        $this->assertInstanceOf('XoopsFormPassword', $instance);
    }
}
