...
require_once(XOOPS_TU_ROOT_PATH . '/class/xoopsform/formcaptcha.php');

class XoopsFormCaptchaTest extends TestCase
{
    ...
    public function test___construct()
    {
        ...
        $this->assertInstanceOf('XoopsFormCaptcha', $instance);
    }
}
