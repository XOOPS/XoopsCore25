...
require_once(XOOPS_TU_ROOT_PATH . '/class/xoopsform/formselectuser.php');

class XoopsFormSelectUserTest extends TestCase
{
    ...
    public function test___construct()
    {
        ...
        $this->assertInstanceOf('XoopsFormSelectUser', $instance);
    }
}
