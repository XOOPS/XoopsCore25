...
require_once(XOOPS_TU_ROOT_PATH . '/class/xoopsform/formeditor.php');

class XoopsFormEditorTest extends TestCase
{
    ...
    public function test___construct()
    {
        ...
        $this->assertInstanceOf('XoopsFormEditor', $instance);
    }
}
